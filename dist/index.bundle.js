...
class UI{
  ...
  renderContent(section) {
    ...
    section.tasks.forEach(task => {
      ...
      taskItem.textContent = `${task.title} - Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(task.dueDate, 'PP')}`;
  ...
  createTestProjects() {
    ...
    const task1 = new _task_js__WEBPACK_IMPORTED_MODULE_0__["default"]('Task 1', 'Description 1', 'High', today);
    const task2 = new _task_js__WEBPACK_IMPORTED_MODULE_0__["default"]('Task 2', 'Description 2', 'Low', today);
    const task3 = new _task_js__WEBPACK_IMPORTED_MODULE_0__["default"]('Task 2', 'Description 2', 'Low', '2024-2-01');
